...
### Self Check
Yes - Do the odd numbered `p` elements share a class?
Yes - Do the even numbered `div` elements have unique IDs?
Yes - Does the Number 3 element have multiple classes?
